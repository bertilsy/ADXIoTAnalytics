...
* If attendee(s) do not have an Azure subscription, or didn't sign-up for a trial prior:
   * You may grant them access using this [script](Others/0_AddAccess.kql) to your ADX cluster (ie. *adxpm#####.northeurope*) to let them get their hands on ADX and run the lab KQL queries. (**Recommended**)
